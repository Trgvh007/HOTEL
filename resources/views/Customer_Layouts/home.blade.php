...
<body>
    ...
    <section class="container-image py-5">
        <div class="container text-center">
            <img src="{{ asset('images/Container.png') }}" alt="VNL Hotel Features" class="img-fluid">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="promotion-card">
                        <div class="image-uudai">
                            <a href="#">
                                <img src="/images/uudai1.png" alt="[WINTER PROMOTION HÀ TĨNH]">
                            </a>
                        </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="promotion-card">
                        <div class="image-uudai">
                            <a href="#">
                                <img src="/images/uudai2.png" alt="[NIGHT DEAL - ƯU ĐÃI TỐI 75%]">
                            </a>
                        </div>
                        <div class="promotion-info">
                ...
                <div class="col-md-3 mb-4">
                    <div class="promotion-card">
                        <div class="image-uudai">
                            <a href="#">
                                <img src="/images/uudai3.png" alt="[WINTER PROMOTION | NHA TRANG]">
                            </a>
                        </div>
                        <div class="promotion-info">
                ...
                <div class="col-md-3 mb-4">
                    <div class="promotion-card">
                        <div class="image-uudai">
                            <a href="#">
                                <img src="/images/uudai4.png" alt="[VNL NGHỈ DƯỠNG SANG CHẢNH]">
                            </a>
                        </div>
                        <div class="promotion-info">
    ...
    <section class="destinations">
        <div class="container">
            ...
            <div class="text-center">
                <img src="{{ asset('images/diemden.png') }}" alt="Điểm đến nổi bật" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section class="about-section" id="about-section">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <img src="{{ asset('images/Gioithieu.png') }}" alt="VNL Luxury Riverfront" class="img-fluid w-100">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul>
                        <li><a href="#">Quản lý đặt chỗ của bạn</a></li>
                ...
                <div class="col-md-4 text-center">
                    <div class="logo">
                        <img src="{{ asset('images/logo1.png') }}" alt="VNL Hotel" class="img-fluid" style="max-width: 500px;">
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <p>© 2023 VNL Hotel. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
